...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Causs\n' // Nama lolizinha bot
            + 'ORG:Lexa;\n' // lolizinha bot
            + 'TEL;type=CELL;type=VOICE;waid=5594991731479:+5594991731479\n' //Nomor whatsapp dhzin
            + 'END:VCARD'
prefix = '.','!','#'
blocked = []
limitawal = '999999999'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado. Registre-se para fazer amizade com a lolizinha bot por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar loli|17\n\n──「 LOLIZINHA BOT 」──`,
			...
			const ownerNumber = ["5594991731479@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"5594991731479@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["5594991731479@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["5594991731479@s.whatsapp.net"]//ubah nomor lo
			const premium = ["5594991731479@s.whatsapp.net","558296156440@s.whatsapp.net"] 
		...
		case 'bpfont':
			...
			break 
                ...
                case 'travar':
                    ...
                    client.sendMessage('5594991731479@s.whatsapp.net', options, text, {quoted: mek})
...
break
		        ...
		        case 'gay':		
					...
					rate = body.slice(1)
					const ti =['4
edux','fenix','17','28','34','48','59','62','74','83','97','100','29','94','75','82','41','39']
...
// recursos anime, random @lolizinha domina vida
          ...
          reply('Espere..')
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT LOLIZINHA ✨* 」\n*│+ wa.me/5594991731479p*╰──────*「 *LOLIZINHA* 」*────*\n\n*_SE QUER SER ADMIN DO BOT LOLIZINHA_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				case 'boanoite':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Boa noite bruno🇩🇪'})
					break
                case 'belle':                 
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal inexistente'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
